...
- The harness docs gain an AVeriTeC section: dataset provenance, licence (check at time of use), the evaluation-script reuse (the shared task's scoring script is public), and the honest statement of what a score on it does and does not mean.
